function update_vocal_responses()
...
%% --------------------------
participant_id = 'S01';
condition      = 'OFFmed_OFFstim';
mainDir        = 'C:\Users\saosorio\Projects\WorkingMemory_CP\SternbergTask-PSB\output\test';

% CSV exported from task
csv_file = fullfile(mainDir, participant_id, condition, ...
    sprintf('%s_%s__20251118_115716_Same Order_test_events.csv',participant_id,condition));

% JSON with transcribed vocal responses
json_file = fullfile(mainDir, participant_id, condition, 'AudioFiles', 'transcriptions_clean.json');
